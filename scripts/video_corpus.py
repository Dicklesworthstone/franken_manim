...
SHIMS: tuple[tuple[str, str, str], ...] = (
    ...
    ("third-party-scene-deps", "packages a scene imports itself (scipy, matplotlib, sympy, pandas, mpmath, colour, ...) belong to the host environment, installed beside fmn-python as they are beside the Reference; the portal neither vendors nor shims them, forwards the Reference's re-exports of them (colour.Color) when installed, and names the missing package when not (fm-5wq.14)", "-"),
)
