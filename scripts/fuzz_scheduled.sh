...
TARGETS=(inflate_bytes decode_png decode_jpeg decode_entry_envelope namespace_and_object_paths svg_document yaml_config tex_math ttf_font_parse path_boolean)
