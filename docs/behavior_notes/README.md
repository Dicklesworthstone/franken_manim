...
| BN-07 | **Reference bugs fixed** (Appendix C rulings) — a family, see rule 2 | [stroke uniforms (C-2, C-7)](BN-07-stroke-uniform-fixes.md) · [updaters, group addition, grid sizing, and FunctionGraph color (C-5, C-6, C-14, C-15)](BN-07-updater-and-group-fixes.md) · [frame-marker constants are unit directions (C-16)](BN-07-frame-marker-constants.md) | W3/W10 | Draft |
