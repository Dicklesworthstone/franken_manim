...
| 13 | Python Studio, reload, embed/checkpoint workflow | **PARTIAL: front door refuses.** Fresh `fmn-python studio` returns exit 4. Native Studio success does not establish Python worker/reload behavior. | `fm-ffj.70`. |
