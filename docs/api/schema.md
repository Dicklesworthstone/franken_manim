...
The single Ledger contains 2483 rows: 2276 Python symbols, 34 Reference CLI flags, 20 FrankenManim-native CLI flags, 4 CLI commands, and 149 config keys. Its reviewed-identity ratchet is `d7cea271024be981957518581a2e7e734040d1bb5445a70a2edec3dd8d8ed115`.
