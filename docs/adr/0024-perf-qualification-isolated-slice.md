...
**Status:** Proposed (awaiting owner ratification on fm-5wq.8)
**Date:** 2026-09-24
**Bead:** fm-5wq.8
...
- Needs owner action on the host: a kernel boot parameter change and a cgroup setup. The verifier change lands in a follow-up leaf citing this ADR. It keeps every existing strictness test, rewritten for the new definition, and adds a negative control per new requirement.
