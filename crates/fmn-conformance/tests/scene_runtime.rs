...
// The scene definitions intentionally live in their own module with one import:
// if the shipped facade cannot express the G1 corpus, this target does not compile.
mod public_corpus {
    use fmn::prelude::*;

    pub(super) const NAMES: [&str; 25] = [
        "circle_shift.v1",
        "rectangle_shift.v1",
        "triangle_shift.v1",
        "pentagon_shift.v1",
    ...
    pub(super) struct PrimitiveScene {
...
use public_corpus::{NAMES, PrimitiveScene};
