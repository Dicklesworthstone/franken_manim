...
| 2 | fmd-math — the clean-room TeX-mathematics layout engine (the largest upstream contribution in suite history): atom classes, spacing table, Appendix-G placement, extensible delimiters, span provenance | franken_markdown · `fmd-math` | Jeffrey Emanuel; W6 sessions | **in-flight** (core pinned 2026-07-24) | core landed upstream as `4328835` (fm-wgl: T1 grammar with SingleStringTex fragment semantics, atom/spacing engine, style machinery, the frozen node model + error contract; corpus goldens green at 99.58 % occurrence-weighted parse coverage) and consumed at the SUITE.lock pin by fmn-tex; Appendix-G placement rides fm-hk9, extensible delimiters/environments/macros ride fm-kg9; API frozen at the G0-3 shape until G2 (R8) |
